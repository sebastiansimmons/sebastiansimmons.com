        ...
        <footer class="footer text-center">
            <div class="container">
                <div class="row">
                    ...
                    {/*  Footer About Text-- */}
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">About The Theme</h4>
                        <p class="lead mb-0">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    {/*  Portfolio Modal - Image-- */}
                                    <img class="img-fluid rounded mb-5" src={require('./assets/img/portfolio/cake.png')} alt="" />
                                    {/*  Portfolio Modal - Text-- */}
                                    <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    {/*  Portfolio Modal - Image-- */}
                                    <img class="img-fluid rounded mb-5" src={require('./assets/img/portfolio/circus.png')} alt="" />
                                    {/*  Portfolio Modal - Text-- */}
                                    <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    {/*  Portfolio Modal - Image-- */}
                                    <img class="img-fluid rounded mb-5" src={require('./assets/img/portfolio/game.png')} alt="" />
                                    {/*  Portfolio Modal - Text-- */}
                                    <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    {/*  Portfolio Modal - Image-- */}
                                    <img class="img-fluid rounded mb-5" src={require('./assets/img/portfolio/safe.png')} alt="" />
                                    {/*  Portfolio Modal - Text-- */}
                                    <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    {/*  Portfolio Modal - Image-- */}
                                    <img class="img-fluid rounded mb-5" src={require('./assets/img/portfolio/submarine.png')} alt="" />
                                    {/*  Portfolio Modal - Text-- */}
                                    <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
